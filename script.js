        ...
        <div id="adminPopupBox">
            ...
            <div class="admin-options">
                ...
                <!--<button id="adminBtn2" class="adminBtn" type="button" disabled>
                    <img class="admin-avatar" src="ASSETS/Admins/gaming.webp" alt="2nd admin profile" width="58" height="58">
                    <span class="admin-name"><strong>Name</strong><small>Store admin 02</small></span>
